...
URL = "https://github.com/andlo/ovos-skill-andersen-tales"
SKILL_CLAZZ = "AndersenTales"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-andersen-tales"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Hans Christian Andersen fairy tales provider skill for ovos-skill-common-tales",
    ...
    keywords="ovos skill voice assistant fairytales andersen storytelling",
